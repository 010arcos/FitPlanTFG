...
class PivotUsuarioDietaSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        DB::table('pivot_usuario_dieta')->insert([
            ...
            [
                'id_usuario' => 1, // Usuario 1 (Admin)
                'id_dieta' => 1,   // Dieta Alta en Proteínas
            ],
            [
                'id_usuario' => 1, // Usuario 1
            ...
            // Usuario 5 asignado a dietas keto y sus alternativas
            [
                'id_usuario' => 5, // Usuario 5
                'id_dieta' => 17,  // Dieta Keto
            ],
            [
                'id_usuario' => 5, // Usuario 5
                'id_dieta' => 18,  // Dieta Keto Variante 1
            ],
            [
                'id_usuario' => 5, // Usuario 5
                'id_dieta' => 19,  // Dieta Keto Variante 2
            ],
            [
                'id_usuario' => 5, // Usuario 5
                'id_dieta' => 20,  // Dieta Keto Variante 3
            ],
        ]);
    }
}