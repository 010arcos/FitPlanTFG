    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <table class="min-w-full table-auto">
                        ...
                        <tbody class="text-sm">
                            ...
                            <tr class="border-b dark:border-gray-600 hover:bg-gray-50 dark:hover:bg-gray-600">
                                <td class="px-6 py-4 text-gray-700 dark:text-gray-300">{{ $ejercicio->id_ejercicio }}
                                </td>
                                <td class="px-6 py-4 text-gray-700 dark:text-gray-300">{{ $ejercicio->nombre }}</td>
                                <td class="px-6 py-4 text-gray-700 dark:text-gray-300">{{ $ejercicio->descripcion }}</td>
                                <td class="px-6 py-4 text-gray-700 dark:text-gray-300">{{ $ejercicio->zona }}</td>
                                <td class="px-6 py-4 text-gray-700 dark:text-gray-300">{{ $ejercicio->tipo }}</td>
                                ...
                                <td class="px-6 py-4">
                                    <div class="flex space-x-2">
                                        ...
                                        <form
                                            action="{{ route('administracion.ejercicios.destroy', $ejercicio->id_ejercicio) }}"
                ...
                <p class="text-gray-600 dark:text-gray-300 mt-6">No se encontraron ejercicios que coincidan con tu
                    búsqueda
                    o no hay ejercicios registrados.</p>
                @endif
