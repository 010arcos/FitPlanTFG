    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <table class="min-w-full table-auto">
                        ...
                        <tbody class="text-sm">
                            ...
                            <tr class="border-b dark:border-gray-600 hover:bg-gray-50 dark:hover:bg-gray-600">
                                ...
                                <td class="px-6 py-4 text-gray-700 dark:text-gray-300 w-[150px]">{{ $dieta->fecha_inicio
                                    }}</td> <!-- Aumenté el ancho de esta celda -->
                                <td class="px-6 py-4 text-gray-700 dark:text-gray-300 w-[150px]">{{ $dieta->fecha_fin }}
                                </td> <!-- Aumenté el ancho de esta celda -->
                ...
                @if(count($dietas) == 0)
                <p class="text-gray-600 dark:text-gray-300 mt-6">No se encontraron dietas que coincidan con tu búsqueda
                    o no hay dietas registrados.</p>
                @endif
