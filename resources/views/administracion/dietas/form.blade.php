...
<form action="{{ $Modo == 'crear' ? url('dietas') : url('dietas/'.$dieta->id_dieta) }}" method="POST"
    ...
    <div class="mb-6">
        ...
        <input type="text" name="nombre" id="nombre" value="{{ old('nombre', $dieta->nombre ?? '') }}"
    ...
    <div class="mb-6">
        ...
        <input type="date" name="fecha_fin" id="fecha_fin" value="{{ old('fecha_fin', $dieta->fecha_fin ?? '') }}"
    ...
    <div class="flex justify-between mt-4">
        ...
        <a href="{{url('administracion/dietas')}}"
